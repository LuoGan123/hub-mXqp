...
class SemanticCache(BaseLLMCache):
    ...
    def clear(self) -> None:
        """Clear the cache of all entries while preserving the index.

        This removes all cached prompt-response pairs but keeps the
        underlying search index intact for future use.
        """
        self._index.clear()

    async def aclear(self) -> None:
        """Async clear the cache of all entries while preserving the index.
